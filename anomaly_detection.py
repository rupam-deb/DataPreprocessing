  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/rupam-deb/DataPreprocessing/blob/synengcotest/anomaly_detection.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      "metadata": {
        "id": "57D8GVR2dHv3",
        "colab_type": "code",
        "outputId": "7c58b34a-afa6-4226-c067-cf064a009895",
        "colab": {
